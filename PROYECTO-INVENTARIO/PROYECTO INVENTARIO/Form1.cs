...
namespace PROYECTO_INVENTARIO
{
    public partial class Form1 : Form
    {
        ...
        {
            int rowIndex = dgvBoard.SelectedCells[0].RowIndex;
            if (rowIndex != -1)
            {
            ...
            //        if (txtCodeStock.Text == cell.Value.ToString())
        ...
        private void btnmost_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataGridViewRow row in dgvBoard.Rows)
            {
                ...
                {
                    double value3 = 0;
                    if (double.TryParse(row.Cells[7].Value.ToString(), out value3))
                    { totalD += value3; }
                    txtstock.Text = totalD.ToString();
                }
            }
        }
        private void btnSave2_Click(object sender, EventArgs e)
        {
            save(txtCodeStock.Text.ToUpper(), int.Parse(txtexit.Text));
        }
